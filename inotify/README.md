See [`Dockerfile`](https://github.com/tianon/docker-syncthing/blob/master/inotify/Dockerfile) and [example `run.sh` script](https://github.com/tianon/docker-syncthing/blob/master/inotify/run.sh) for usage.
